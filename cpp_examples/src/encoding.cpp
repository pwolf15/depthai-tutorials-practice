...
int main() {
    ...
    // Setting to 26fpgs will trigger error
    ...
    cout << "To view the encoded data, convert the stream file (.h264/.h265) into a video file (.mp4), using command below:" << endl;
    cout << "ffmpeg -framerate 25 -i mono1.h264 -c mono1.mp4" << endl;
    cout << "ffmpeg -framerate 25 -i mono2.h264 -c mono2.mp4" << endl;
    cout << "ffmpeg -framerate 25 -i color.h265 -c color.mp4" << endl;
